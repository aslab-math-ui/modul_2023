...
::: {.callout-warning}
## Perhatikan
Modul ini termasuk arsip, artinya tidak siap atau tidak dimaksudkan untuk digunakan.
:::
...
* [Modul 1: Pengenalan bahasa C: data, ekspresi, pernyataan, dan alur logika](Strukdat2023_Modul01.qmd)
* [Modul 2: *Array*, fungsi, *struct*, dan proses kompilasi](Strukdat2023_Modul02.qmd)
* [Modul 3: Operasi *array*, algoritma *searching* dan *sorting*](Strukdat2023_Modul03.qmd)
* [Modul 4: *Pointer*, memori, CodeChef, input dan manipulasi *string*](Strukdat2023_Modul04.qmd)
    + [Modul 4a (opsional): ASCII, Unicode, `inttypes.h`, dan manipulasi *text file*](Strukdat2023_Modul04a.qmd)
    + [Modul 4b (opsional): membuat *command-line interface* (CLI) dengan `argv`](Strukdat2023_Modul04b.qmd)

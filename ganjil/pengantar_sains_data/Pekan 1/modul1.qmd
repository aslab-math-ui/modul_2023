...
* [Iris.csv](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.csv)

* [Iris.xlsx](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.xlsx)
...
atau kalo mau import data dari file [Iris.csv](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.csv) atau [Iris.xlsx](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.xlsx)

```{r}
df <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.csv") #janlup dikasih tau parameternya path ya jadi bebas
```
...
```{r}
library(readr)
df <- read_csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.csv")
